...
export const Calendar = React.memo(
    React.forwardRef((props, ref) => {
        ...
        const updateInputfield = (value) => {
            ...
            try {
                if (value !== null && value !== '') {
                    let year = props.locale === 'th'?parseInt(value.getFullYear()) + 543:parseInt(value.getFullYear());
                  if (props.showTime === true) {
                    value = new Date(year, value.getMonth(), value.getDate(), value.getHours(), value.getMinutes(), value.getSeconds(), value.getMilliseconds());
                  } else {
        ...
        const createTitleYearElement = () => {
            if (props.yearNavigator) {
                ...
                const content = (
                    <select className="p-datepicker-year" 
